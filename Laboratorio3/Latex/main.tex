...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{Síntesis de Redes Activas - Laboratorio n° 3}
\fancyfoot[LE,RO]{\thepage}
\fancyfoot[LO]{Britez - Corvalán - Rodriguez}
...
\newpage
\section{Desarrollo}
\input{VFA VFA/Circuito 1 - VFA VFA}
\newpage
\input{VFA - CFA/Circuito 2 - VFA CFA}
\newpage
\input{VFA CFA Compensado/Circuito 3 - VFA CFA Compensado}
\newpage
